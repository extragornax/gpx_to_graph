...
fn verify_account(state: &super::AppState, slug: &str, headers: &HeaderMap) -> Result<(super::db::Account, String), StatusCode> {
...
fn ensure_account_session(state: &super::AppState, account: &super::db::Account) -> Result<String, StatusCode> {
