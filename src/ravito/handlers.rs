...
use super::gpx_parse::{KmSample, cumulative_km, parse_track, project_to_route, sample_by_km};
use super::hours::{Openness, status_at};
use super::overpass::OverpassCache;
...
const INDEX_HTML: &str = include_str!("../../static/ravito/index.html");
const APP_CSS: &str = include_str!("../../static/ravito/app.css");
