...
use super::gpx_parse::{KmSample, parse_track, sample_by_km};
use super::weather::WeatherCache;
use super::wind::{RidePoint, WindowScore, headwind_exposure, ride_forecast};
...
const INDEX_HTML: &str = include_str!("../../static/meteo/index.html");
const APP_CSS: &str = include_str!("../../static/meteo/app.css");
