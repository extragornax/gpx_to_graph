...
- sideways ASCII kilometer labels (readable after rotating/flipping for stem mounting)
...
Full-image mirror (everything is flipped left-right):
...
- `--mirror`: flip the whole output image horizontally after rendering
